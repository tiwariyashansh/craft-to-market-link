...
import { KarigarProvider } from "@/lib/karigar/store";
import { Toaster } from "@/components/ui/sonner";

function NotFoundComponent() {
  return (
    <div className="paper-surface flex min-h-screen items-center justify-center px-4">
  ...
  head: () => ({
    meta: [
      ...
      { title: "KarigarSetu — From Traditional Craft to Digital Market" },
      {
        name: "description",
        content:
          "An AI business assistant that turns an artisan's photo or voice note into a ready listing, a fair price, and matched buyers.",
      },
      { name: "author", content: "KarigarSetu" },
